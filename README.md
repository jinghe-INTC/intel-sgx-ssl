...
This branch supports OpenSSL version 3.1.x, but works in 1.1.1 compatible mode.
...
1. Download OpenSSL 3.1.x package into openssl_source/ directory. (tar.gz package, e.g. openssl-3.1.*.tar.gz)
