...
Supported OpenSSL version is 1.1.1l. To work with 1.1.0 version please use "openssl_1.1.0" branch.
...
1. Checkout OpenSSL repo of a proper branch, into the parent directory:
```
git clone -b OpenSSL_1_1_1l git@github.com:openssl/openssl.git ../openssl
```
